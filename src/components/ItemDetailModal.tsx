                ...
                <div className="sm:col-span-2 space-y-2">
                  <div className="aspect-16/10 rounded-2xl bg-slate-100 border border-slate-200 overflow-hidden shadow-2xs relative">
                    {item.photo1 || item.photo2 ? (
                      <img 
                        src={activePhoto || item.photo1 || item.photo2} 
                        alt={item.name} 
                  ...
                  {(item.photo1 && item.photo2) && (
                    <div className="flex gap-2">
                      <button
                        onClick={() => setActivePhoto(item.photo1!)}
                      ...
                      >
                        <img src={item.photo1} alt="Photo 1" className="w-full h-full object-cover" />
                      </button>
                      <button
                        onClick={() => setActivePhoto(item.photo2!)}
                        className={`w-16 h-12 rounded-lg border overflow-hidden cursor-pointer ${
                          activePhoto === item.photo2 ? 'ring-2 ring-blue-500' : 'opacity-70'
                        }`}
                      >
                        <img src={item.photo2} alt="Photo 2" className="w-full h-full object-cover" />
                      </button>
                    </div>
                  )}
                </div>
